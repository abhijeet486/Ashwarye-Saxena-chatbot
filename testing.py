...
text_splitter  = CharacterTextSplitter(
    chunk_size=3000,  # The number of tokens in each chunk
...
embedding_model = SentenceTransformerEmbeddings(model_name="BAAI/bge-large-en")
...
query = " provide contact information" 
response = process_unstr_query(query)
print(response)